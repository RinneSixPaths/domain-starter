...
const price = '0.001';
const tld = '.hgwrts';
const CONTRACT_ADDRESS = '0x674683b152aEaBDdCCf193381aA6E2138678E9E8';

// TODO: Show meaningful errors from ethers.js
...
const App = () => {
  ...
  const mintDomain = async () => {
    ...
    try {
      ...
      if (ethereum) {
        ...
        let tx = await contract.applyToHogwarts(domain, patronus, Math.floor(Math.random() * 100), { value: ethers.utils.parseEther(price), gasLimit: 10e6 });
  ...
  const renderNotConnectedContainer = () => (
    <div className="connect-wallet-container">
      <img src="https://media.giphy.com/media/BJmTtZL4hova8/giphy.gif" alt="Ron is casting a spell" />
